...
public class BTree implements BTreeInterface
{
	...
	private int bytesPerKey = 12;
	private int bytesPerChild = 4;
	private int otherBytesInNode = 8;
	...
	public BTree(int degree) throws IOException //without cache
	{
		...
		nodeSize = ((2*degree - 1)*bytesPerKey) + ((2*degree)*bytesPerChild) + otherBytesInNode;
